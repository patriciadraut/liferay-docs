...
gateway to managing your servers in LCS. 
...
The UI is segmented into two tabs: 

1. **Registration:** Generate and download 
    [*environment tokens*](/docs/7-2/deploy/-/knowledge_base/d/understanding-environment-tokens) 
    that connect your servers to LCS. 

2.  **Environment Settings:** Change the environment's name, location, and
